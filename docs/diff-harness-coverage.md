...
Auto-generated by `tools/audit_diff_coverage.py` on 2026-07-29. Do
not edit by hand — re-run the tool to refresh.

- 69 registered reference backends
- 0 have a frozen reference archive on disk
- 59 have a `crispasr-diff` C++ harness branch
- **0 are fully wired** (archive + harness branch)
- 69 have at least one gap
