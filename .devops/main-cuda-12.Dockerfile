...
RUN jobs="${CRISPASR_BUILD_JOBS:-$(nproc)}" && \
    ...
    -DGGML_BMI2=ON -DGGML_SSE42=ON -DGGML_AVX=ON -DGGML_AVX512=OFF \
        -DCMAKE_CUDA_ARCHITECTURES="61-real;70-real;75-real;80-real;86-real;89-real;90-real;90-virtual" \
...
LABEL org.opencontainers.image.description="crispasr unified ASR — CUDA 12.4 build (driver R510+; sm_61-90)"
