...
The static table below is a curated subset focusing on the ASR backends and the cross-cutting features that matter for ASR pipelines. The full 104-backend × 27-cap surface is in the generated views.
